...
//     const media =  mediaData.find(media => media.messageId === messageId);
//     return media? [media] : []
// }
export function getAllMediaByMessageId(messageId: number): MediaProps[] {
    // Filter out all media by messageId (assuming you're storing media in a separate array or object)
