...
//     // ========== SFU MEMBER MANAGEMENT ==========
//     addSFUMember: (member: Partial<callMember> & { memberId: string }) => {
//       set((state) => {
//         if (state.sfuMembers.find((m) => m.memberId === member.memberId))
//           return state;
...
//     updateSFUMember: (member: Partial<callMember> & { memberId: string }) => {
//       set((state) => {
