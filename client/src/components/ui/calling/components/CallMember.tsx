...
const CallMember = ({
  ...
  console.log(`🎙️Member voiceStream:`, member.voiceStream);
  console.log(`🎙️Voice stream type:`, typeof member.voiceStream);
  console.log(
    `🎙️Voice stream keys:`,
    member.voiceStream ? Object.keys(member.voiceStream) : "null"
  );
  // console.log(
