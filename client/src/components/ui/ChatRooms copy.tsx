...
//     const activeClasses = activeRoom?.id === chatId ? "bg-[var(--active-chat-color)]" : " hover:bg-[var(--hover-color)]";
...
//           <div className={getUserItemClass(chat.id)} onClick={() => setActiveRoom(chat)}>
//             {!chat.isGroup ?
