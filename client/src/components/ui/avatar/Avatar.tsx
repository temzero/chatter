...
export const Avatar: React.FC<AvatarProps> = ({
  ...
  return (
    <div
      key={id}
      title={name}
      className={`relative w-${size} h-${size} aspect-square flex items-center justify-center overflow-hidden rounded-full! border-2 bg-(--input-border-color) backdrop-blur ${
