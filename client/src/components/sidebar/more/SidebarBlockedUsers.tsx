            ...
            <div key={id} className="flex flex-col items-center group">
              ...
              >
                ...
                <button
                  ...
                  className="opacity-0 custom-border p-1.5 rounded-full! hover:bg-(--primary-green) hover:text-(--panel-color) group-hover:opacity-100 text-(--primary-green) text-sm font-semibold"
                >
