...
const SidebarSettingsTheme: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div
        style={{ zIndex: 99 }}
        className="absolute bottom-0 left-0 right-0 p-2 border-4 border-b-0 border-(--border-color) overflow-hidden bg-(--sidebar-color) space-y-2 rounded-t-2xl shadow-4xl"
      >
        {/* Preview */}
        <div className="p-2 space-y-2">
          ...
          <div className="w-3/4 h-10 rounded-lg custom-border bg-(--message-color) hover:scale-110 origin-bottom-left transition-all" />
          <div className="w-1/2 h-10 rounded-lg custom-border ml-auto bg-(--primary-green) hover:scale-110 origin-bottom-right transition-all" />
