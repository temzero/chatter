...
const SidebarProfileEdit: React.FC = () => {
    const { myProfile, setMyProfile } = useGlobalContext();
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        setSidebar('profile'); // Return to profile view after saving
    };
    ...
    return (
        <aside className="relative w-[var(--sidebar-width)] h-full flex flex-col transition-all duration-300 ease-in-out">
            ...
            <header className="flex w-full justify-between items-center min-h-[var(--header-height)] custom-border-b">
                <div className="flex items-center">
                    <i className="material-symbols-outlined nav-btn"
                     onClick={() => setSidebar('profile')}>arrow_back</i>
            ...
            <div className='flex gap-2 justify-center items-center cursor-pointer p-2 text-blue-500 custom-border-t absolute bottom-0 w-full'
