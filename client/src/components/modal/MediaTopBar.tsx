  ...
  return (
    <div className="absolute top-0 left-0 right-0 flex justify-between items-center p-2 pb-8 z-20">
      ...
      <div className="flex items-center gap-4">
        ...
        <button onClick={handleDownloadClick} className="text-white/60 hover:text-white rounded-full">
          <i className="material-symbols-outlined">download</i>
        </button>
        <button className="text-white/60 hover:text-white rounded-full">
          <i className="material-symbols-outlined">delete</i>
        </button>
        <button className="text-white/60 hover:text-white rounded-full" onClick={onClose}>
